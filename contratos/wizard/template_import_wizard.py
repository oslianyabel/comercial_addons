...
class ContratoTemplateImportWizard(models.TransientModel):
    _name = "contrato.template.import.wizard"
    _description = "Import TXT for Contract Template"
    ...
    def action_import(self):
        ...
        try:
            ...
            raise UserError(
                _("The file could not be read. Please ensure it is a valid UTF-8 text file.")
            )
        ...
        filename = templates_map.get(template.type)
        if not filename:
        ...
        return {
            ...
            "params": {
                ...
                "message": _("The template file has been replaced and the template content has been updated."),
                "sticky": False,
